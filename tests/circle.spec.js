...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contendo os valores esperados', () => {
    ...
    expect(circle("naoNumero")).toBe(undefined)
    ...
    const circulo1 = circle(4)
    const tamanhoCirculo1 = Object.keys(circulo1).length

    expect(tamanhoCirculo1).toBe(3)
    ...
    const circunferencia = circulo2.circumference
    ...
    const area = parseFloat((circulo3.area).toFixed(2))
    ...
    const circulo4 = { radius: 3, area: 28.259999999999998, circumference: 18.84 }

    expect(circle(3)).toEqual(circulo4)
  });
});
